...
@DisplayName("Test from Selenium IDE to buy a book on a fictional website converted to JUnit Jupiter using Selenium-Jupiter")
class EdgeSeleniumIDEBookTest {

    static final Logger log = getLogger(lookup().lookupClass());

    @Test
    @DisplayName("testBookDemoBefore")
    void testBookDemoBefore(EdgeDriver driver) {
    ...
    void testBookDemoAfter(EdgeDriver driver) {
