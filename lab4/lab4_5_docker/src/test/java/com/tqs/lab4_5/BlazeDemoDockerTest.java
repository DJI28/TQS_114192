...
// Same as exercise 2 but with the use of a Docker browser
...
@DisplayName("Exercise 2 on BlazeDemo website using Docker browser")
class BlazeDemoDockerTest {

    static final Logger log = getLogger(lookup().lookupClass());

    @Test
    @DisplayName("testBlazeDemo")
    void testBlazeDemo(@DockerBrowser(type = BrowserType.CHROME) WebDriver driver) {
